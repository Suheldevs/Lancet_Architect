...
const BlogDetail = () => {
  ...
  if (!blog)
    return <div className="text-red-500 text-xl my-24  font-semibold text-center">Blog Not Found!</div>;
            ...
            {relatedBlogs.length === 0 ? (
              ...
              relatedBlogs.map((relatedBlog) => (
                ...
                >
                  ...
                  />
                  <p className="text-gray-500 text-sm mt-2">{formattedDate(relatedBlog.date)}</p>
